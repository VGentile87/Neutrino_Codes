...
TH1D *h3 = new TH1D("the_sc","",100,-pi,pi);
TH1D *h33 = new TH1D("phi_sc","",100,-pi,pi);
TH1D *h4 = new TH1D("ene_rec","ene_rec",2000,0,2000);
TH1D *h44 = new TH1D("ene_rec_thr_1kev","ene_rec_thr_1kev",2000,0,2000);
TH1D *h5 = new TH1D("phi_sum","",100,-pi,pi);
TH1D *h55 = new TH1D("the_sum","",50,-pi/2.,pi/2.);
...
TH1D *hene_thr = new TH1D("ene_thr","ene_thr",2000,0,2000);
TH1D *hlen_thr = new TH1D("L_thr","L_thr",50,0.05,1);
TH1D *hphi_thr = new TH1D("phi_thr","phi_thr",100,-pi,pi);
TH1D *hthe_thr = new TH1D("the_thr","the_thr",100,-pi,pi);
...
TH1D *h00 = new TH1D("h00","h00",100,0,2*pi);
TH1D *h0 = new TH1D("pthe_comp","h0",100,-pi,pi);
...
TH1D *hphi = new TH1D("phi_rec","phi_rec",100,-pi,pi);
...
Double_t theta_sum_comp = 0;
Double_t cos_theta_sum = 0;


TH3D *hxyzrec = new TH3D("hxyzrec","",100,-1,1,100,-1,1,100,-1,1);
TH1D *hphirec = new TH1D("hphirec","",100,-pi,pi);
TH1D *htherec = new TH1D("htherec","",100,-pi/2.,pi/2.);
