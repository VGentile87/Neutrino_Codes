...
Double_t flux_atm=10.5;
Double_t int_const_bkg=0.;
Double_t dN_vs_dE_bkg=0.;
Double_t flux_atm_vs_E[818]={};
Double_t integral_flux_atm = 10.5;
Double_t iflux_atm_vs_E=0.;
...
TH1D *h_len = new TH1D("L_true_atm","L_true_atm",150,0,1.5);
