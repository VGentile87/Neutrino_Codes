...
Double_t flux_hep=8.04*TMath::Power(10,3);
Double_t int_const_bkg=0.;
Double_t dN_vs_dE_bkg=0.;
Double_t flux_hep_vs_E[818]={};
Double_t integral_flux_hep = 8.04*TMath::Power(10,3);
Double_t iflux_hep_vs_E=0.;
...
TH1D *h_len = new TH1D("L_true_hep","L_true_hep",150,0,1.5);
